...
export function Footer(props: {
  ...
  const isMobile = true;
  return (
    <footer className='w-full bg-atlantiBlue text-white font-roboto'>
      <div className='container mx-auto px-12 py-20'>
        <div className='flex flex-col md:flex-row gap-20 text-gray-400 text-[14px]'>
          ...
          <div className='md:w-1/4 text-end'>
      ...
      <div className='container mx-auto px-12 pb-20'>
        <div className='flex flex-col md:flex-row justify-between gap-20 text-gray-400 text-[14px]'>
          <div className='leading-relaxed'>
